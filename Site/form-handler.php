<?php
// ══════════════════════════════════════════════════════════════
//  HANDLER DE FORMULÁRIOS — recebe POST via fetch() do front-end
//  Suporta múltiplos tipos de form via campo oculto "form_type"
//  Adapte as funções handle_*() para cada formulário do projeto
// ══════════════════════════════════════════════════════════════
...
function handle_candidato() {
    ...
    $corpo = "Nova candidatura recebida.\n\n"
           . "Nome:     {$nome}\n"
           . "E-mail:   {$email}\n"
           . "Telefone: {$telefone}\n"
           . "Área:     {$area}\n"
...
function handle_fornecedor() {
    ...
    $corpo = "Novo fornecedor cadastrado.\n\n"
